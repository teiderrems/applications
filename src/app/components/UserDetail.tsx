   ...
   <div className="fixed inset-0  flex justify-center items-center flex-col">
        ...
        <div className="flex flex-col w-4/6 h-4/6  md:h-5/6 md:p-5 p-4 justify-center space-y-4 items-center bg-white z-10 opacity-100 rounded-md shadow">
            <div className="w-full h-32 md:h-32 flex md:mt-4 md:space-x-10  md:space-y-0 space-y-4 md:flex-row flex-col">
                <input type="text" disabled onChange={(e)=>setCurrentUser({...currentUser,Username:e.target.value})} placeholder="Enter your Username" className="md:w-5/6 w-full flex-1 pl-1 md:h-4/6 shadow shadow-blue-200 border-2 rounded-md" id="username" value={currentUser.Username} />
            ...
            <div className=" w-full h-16 flex  flex-col">
                <input name="Email" disabled onChange={(e)=>setCurrentUser({...currentUser,Email:e.target.value})} type="email"  className="w-full flex-1 h-5/6 px-2 md:h-4/6 shadow shadow-blue-200 border-2 rounded-md" id="email" value={currentUser.Email}></input>
            </div>
            <div className=" w-full h-16 flex  flex-col">
                <input name="Firstname" disabled onChange={(e)=>setCurrentUser({...currentUser,Firstname:e.target.value})}  className="w-full flex-1 h-5/6 px-2 md:h-4/6 shadow shadow-blue-200 border-2 rounded-md" id="firstname" placeholder="Enter your Firstname" value={currentUser.Firstname}></input>
            </div>
            <div className="w-full h-16 md:h-20 flex  flex-col">
                <input name="Lastname" disabled onChange={(e)=>setCurrentUser({...currentUser,Lastname:e.target.value})} placeholder="Enter your Lastname" className="w-full flex-1 h-5/6 px-2 md:h-4/6 shadow shadow-blue-200 border-2 rounded-md" id="lastname" value={currentUser.Lastname}></input>
            </div>
