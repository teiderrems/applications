...
import {Avatar, Button, Descriptions, Image, Input, message, Modal} from "antd";
...
export default function UserDetailInfo() {
    ...
    } = useFindOneQuery(param as string);
                        ...
                        <Descriptions layout={"vertical"} size={"small"} title="User Info" column={1} items={[
                            {
                                key: '1',
                                label: 'FirstName',
                                children: <Input defaultValue={userEdit?.Firstname} size={"large"}
                                                 disabled={!isEditable}
                            ...
                            },
                            {
                                key: '2',
                                label: 'LastName',
                                children: <Input disabled={!isEditable} size={"large"} defaultValue={userEdit?.Lastname}
                                                 onChange={(e) => setUser({...user, Lastname: e.target.value})}/>,
                            },
                            {
                                key: '3',
                                label: 'Email',
                                children: <Input disabled={!isEditable} size={"large"} defaultValue={userEdit?.Email}
                                                 type="email"
